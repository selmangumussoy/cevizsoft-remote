...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip1", "CevizSoft Remote இந்த Android சாதனத்தை கட்டுப்படுத்த \"அணுகல் சேவைகள்\" அனுமதி தேவை."),
        ("android_input_permission_tip2", "சிஸ்டம் அமைப்புகளில் [நிறுவப்பட்ட சேவைகள்] கண்டுபிடித்து, CevizSoft Remote சேவை இயக்கவும்."),
        ...
        ("Language", "மொழி"),
        ("Keep CevizSoft Remote background service", "CevizSoft Remote பின்புல சேவையை வைத்திரு"),
        ("Ignore Battery Optimizations", "பேட்டரி மேம்படுத்தல்களை புறக்கணி"),
        ("android_open_battery_optimizations_tip", "CevizSoft Remote க்கு பேட்டரி மேம்படுத்தல் அணைக்க அமைப்புகளுக்கு செல்லவும்"),
        ...
        ("Show CevizSoft Remote", "CevizSoft Remote ஐ காட்டு"),
        ("This PC", "இந்த PC"),
        ("or", "அல்லது"),
        ("Elevate", "உயர்த்து"),
        ...
        ("verify_CevizSoft Remote_password_tip", "CevizSoft Remote_கடவுச்சொல்_சரிபார்ப்பு_குறிப்பு"),
        ...
        ("scam_text2", "CevizSoft Remote ஊழியர் இவ்வாறு தொடர்பு கொள்ள மாட்டார்கள்"),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "CevizSoft Remote Server Pro {} க்கு மேம்படுத்து"),
        ...
        ("selinux_tip", "SELinux இயக்கப்பட்டது, CevizSoft Remote அனுமதி வேண்டும்"),
        ...
        ("enable-2fa-desc", "CevizSoft Remote இரு காரணி அங்கீகாரம் ஆதரிக்கிறது"),
        ...
        ("enable-bot-desc", "CevizSoft Remote Telegram போட் ஆதரிக்கிறது"),
        ("cancel-2fa-confirm-tip", "2fa_ரத்து_உறுதி_குறிப்பு"),
        ("cancel-bot-confirm-tip", "போட்_ரத்து_உறுதி_குறிப்பு"),
        ("About CevizSoft Remote", "CevizSoft Remote பற்றி"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "ரிமோட்_CevizSoft Remote_கிளையன்டை_{}_மேம்படுத்து_குறிப்பு"),
        ...
        ("allow-insecure-tls-fallback-tip", "இயல்பாக, TLS ஐப் பயன்படுத்தும் நெறிமுறைகளுக்கு CevizSoft Remote சர்வர் சான்றிதழை சரிபார்க்கிறது.\nஇந்த விருப்பம் இயக்கப்பட்டால், சரிபார்ப்பு தோல்வியடைந்தால் CevizSoft Remote சரிபார்ப்பு படிநிலையைத் தவிர்த்து தொடரும்."),
        ("Disable UDP", "UDP ஐ முடக்கு"),
        ("disable-udp-tip", "TCP ஐ மட்டுமே பயன்படுத்த வேண்டுமா என்பதைக் கட்டுப்படுத்துகிறது.\nஇந்த விருப்பம் இயக்கப்பட்டால், CevizSoft Remote இனி UDP 21116 ஐப் பயன்படுத்தாது, அதற்குப் பதிலாக TCP 21116 பயன்படுத்தப்படும்."),
        ("server-oss-not-support-tip", "குறிப்பு: CevizSoft Remote சர்வர் OSS இந்த அம்சத்தை உள்ளடக்கவில்லை."),
