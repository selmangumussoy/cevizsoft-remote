...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na CevizSoft Remote mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a CevizSoft Remote ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate CevizSoft Remote na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, CevizSoft Remote-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, CevizSoft Remote-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti CevizSoft Remote-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [CevizSoft Remote Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep CevizSoft Remote background service", "Zadrži CevizSoft Remote kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje CevizSoft Remote aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show CevizSoft Remote", "Prikaži CevizSoft Remote"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti CevizSoft Remoteu dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti CevizSoft Remoteu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog CevizSoft Remotea."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Provjera lozinke za CevizSoft Remote"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete CevizSoft Remote, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Ažurirajte CevizSoft Remote Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti CevizSoft Remote da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor CevizSoft Remotea otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa CevizSoft Remotea"),
        ...
        ("About CevizSoft Remote", "O CevizSoft Remoteu"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Molimo ažurirajte CevizSoft Remote klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, CevizSoft Remote provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, CevizSoft Remote će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, CevizSoft Remote više neće koristiti UDP 21116, već će umjesto toga koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: CevizSoft Remote poslužitelj OSS ne uključuje ovu značajku."),
