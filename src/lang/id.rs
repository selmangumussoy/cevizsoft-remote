...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke CevizSoft Remote..."),
        ...
        ("install_tip", "Karena UAC, CevizSoft Remote tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal CevizSoft Remote ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk CevizSoft Remote."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk CevizSoft Remote."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd CevizSoft Remote untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input CevizSoft Remote]."),
        ...
        ("Language", "Bahasa"),
        ("Keep CevizSoft Remote background service", "Pertahankan CevizSoft Remote berjalan pada service background"),
        ...
        ("Show CevizSoft Remote", "Tampilkan CevizSoft Remote"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada CevizSoft Remote"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada CevizSoft Remote"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC CevizSoft Remote yang sedang berjalan"),
        ...
        ("verify_CevizSoft Remote_password_tip", "Verifikasi Kata Sandi CevizSoft Remote"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan CevizSoft Remote, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Silahkan perbarui CevizSoft Remote Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah CevizSoft Remote berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela CevizSoft Remote sedang terbuka."),
        ...
        ("floating_window_tip", "Untuk menjaga layanan/service CevizSoft Remote agar tetap aktif"),
        ...
        ("About CevizSoft Remote", "Tentang CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Silahkan perbarui aplikasi CevizSoft Remote ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Secara default, CevizSoft Remote memverifikasi sertifikat server untuk protokol yang menggunakan TLS.\nDengan opsi ini diaktifkan, CevizSoft Remote akan kembali melewati langkah verifikasi dan melanjutkan jika verifikasi gagal."),
        ("Disable UDP", "Nonaktifkan UDP"),
        ("disable-udp-tip", "Mengontrol apakah hanya menggunakan TCP.\nSaat opsi ini diaktifkan, CevizSoft Remote tidak akan menggunakan UDP 21116 lagi, TCP 21116 akan digunakan sebagai gantinya."),
        ("server-oss-not-support-tip", "CATATAN: CevizSoft Remote server OSS tidak menyertakan fitur ini."),
