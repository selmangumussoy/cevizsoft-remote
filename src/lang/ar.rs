...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة CevizSoft Remote..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. CevizSoft Remote قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت CevizSoft Remote في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح CevizSoft Remote اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح CevizSoft Remote اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ CevizSoft Remote باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [CevizSoft Remote Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep CevizSoft Remote background service", "ابق خدمة CevizSoft Remote تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق CevizSoft Remote, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show CevizSoft Remote", "عرض CevizSoft Remote"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من CevizSoft Remote اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح CevizSoft Remote اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في CevizSoft Remote الذي يعمل."),
        ...
        ("verify_CevizSoft Remote_password_tip", "تحقق من كلمة مرور CevizSoft Remote"),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "ترقية خادم CevizSoft Remote Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع CevizSoft Remote"),
        ...
        ("About CevizSoft Remote", "حول CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "ترقية عميل CevizSoft Remote البعيد إلى {}"),
