...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua CevizSoft Remote..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca CevizSoft Remote să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala CevizSoft Remote."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți CevizSoft Remote acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți CevizSoft Remote acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți CevizSoft Remote să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [CevizSoft Remote Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep CevizSoft Remote background service", "Rulează serviciul CevizSoft Remote în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației CevizSoft Remote, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show CevizSoft Remote", "Afișează CevizSoft Remote"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi CevizSoft Remote permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi CevizSoft Remote permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din CevizSoft Remote care rulează."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Verifică parola CevizSoft Remote"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi CevizSoft Remote pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Versiunea serverului CevizSoft Remote Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul CevizSoft Remote pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu CevizSoft Remote"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web CevizSoft Remote Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări CevizSoft Remote. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About CevizSoft Remote", "Despre CevizSoft Remote"),
        ...
        ("web_id_input_tip", "Introdu ID-ul CevizSoft Remote al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Versiunea clientului CevizSoft Remote de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește CevizSoft Remote Pro pentru funcționalitate completă."),
