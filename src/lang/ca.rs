...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de CevizSoft Remote..."),
        ...
        ("Website", "Lloc web"),
        ("About", "Quant al CevizSoft Remote"),
        ...
        ("install_tip", "En alguns casos és possible que el CevizSoft Remote no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el CevizSoft Remote al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al CevizSoft Remote els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al CevizSoft Remote els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al CevizSoft Remote l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «CevizSoft Remote Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep CevizSoft Remote background service", "Manté el servei del CevizSoft Remote en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del CevizSoft Remote, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("elevated_foreground_window_tip", "La finestra de connexió actual requereix permisos ampliats per a funcionar i, de forma temporal, no es pot utilitzar ni el teclat ni el ratolí. Demaneu a l'usuari remot que minimitzi la finestra actual, o bé que faci clic al botó Permisos ampliats de la finestra d'administració de la connexió. Per a evitar aquest problema en un futur, instal·leu el CevizSoft Remote al dispositiu remot."),
        ...
        ("Show CevizSoft Remote", "Mostra el CevizSoft Remote"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al CevizSoft Remote els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al CevizSoft Remote els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del CevizSoft Remote en execució."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Verifica la contrasenya del CevizSoft Remote"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del CevizSoft Remote, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Actualitzeu el CevizSoft Remote Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el CevizSoft Remote funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del CevizSoft Remote està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del CevizSoft Remote en rerefons"),
        ...
        ("About CevizSoft Remote", "Quant al CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Actualitzeu el client CevizSoft Remote a la versió {} o superior a la part remota!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per defecte, el CevizSoft Remote verifica el certificat del servidor per als protocols que utilitzen TLS.\nAmb aquesta opció habilitada, el CevizSoft Remote ometrà el pas de verificació i continuarà en cas que aquesta falli."),
        ("Disable UDP", "Inhabilita l'UDP"),
        ("disable-udp-tip", "Controla si s'utilitza només TCP.\nAmb aquesta opció habilitada, el CevizSoft Remote ja no utilitzarà l'UDP 21116, sinó que utilitzarà el TCP 21116 en el seu lloc."),
        ("server-oss-not-support-tip", "NOTA: El CevizSoft Remote Server OSS no inclou aquesta característica."),
