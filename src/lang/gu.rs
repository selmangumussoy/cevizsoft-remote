...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "કૃપા કરીને સેટિંગ્સમાં CevizSoft Remote શોધો અને તેને ચાલુ કરો."),
        ...
        ("Language", "ભાષા"),
        ("Keep CevizSoft Remote background service", "CevizSoft Remote બેકગ્રાઉન્ડ સેવા ચાલુ રાખો"),
        ...
        ("Show CevizSoft Remote", "CevizSoft Remote બતાવો"),
        ("This PC", "આ PC"),
        ("or", "અથવા"),
        ("Elevate", "એલિવેટ કરો"),
        ...
        ("verify_CevizSoft Remote_password_tip", "CevizSoft Remote પાસવર્ડ ચકાસો"),
        ...
        ("scam_text1", "જો તમે અજાણી વ્યક્તિ સાથે વાત કરી રહ્યા હો અને તેણે CevizSoft Remote વાપરવા કહ્યું હોય, તો તરત ડિસ્કનેક્ટ કરો."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "સર્વર પ્રો ને {} માં અપગ્રેડ કરો"),
        ...
        ("allow-only-conn-window-open-tip", "માત્ર CevizSoft Remote વિન્ડો ખુલ્લી હોય ત્યારે જ કનેક્શનની મંજૂરી આપો"),
        ...
        ("floating_window_tip", "બેકગ્રાઉન્ડમાં હોય ત્યારે CevizSoft Remote બતાવો"),
        ...
        ("About CevizSoft Remote", "CevizSoft Remote વિશે"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "રિમોટ ક્લાયન્ટને {} માં અપગ્રેડ કરો"),
