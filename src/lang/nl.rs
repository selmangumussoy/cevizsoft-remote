...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het CevizSoft Remote netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer CevizSoft Remote op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u CevizSoft Remote toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u CevizSoft Remote toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u CevizSoft Remote toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [CevizSoft Remote Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep CevizSoft Remote background service", "CevizSoft Remote achtergronddienst behouden"),
        ...
        ("Show CevizSoft Remote", "Toon CevizSoft Remote"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ("Elevate", "Verhoog"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u CevizSoft Remote toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u CevizSoft Remote toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Bevestiging wachtwoord CevizSoft Remote"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om CevizSoft Remote te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Upgrade CevizSoft Remote Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor CevizSoft Remote mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("powered_by_me", "Werkt met CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het CevizSoft Remote-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt CevizSoft Remote op de achtergrond actief te houden"),
        ...
        ("About CevizSoft Remote", "Over CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Upgrade de CevizSoft Remote client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert CevizSoft Remote het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat CevizSoft Remote verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt CevizSoft Remote niet langer UDP 21116, maar TCP 21116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de CevizSoft Remote-server."),
