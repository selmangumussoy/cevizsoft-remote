...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään CevizSoft Remote verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa CevizSoft Remote ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi CevizSoft Remotein järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava CevizSoft Remoteille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava CevizSoft Remoteille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten CevizSoft Remote daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota CevizSoft Remoteille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli CevizSoft Remote ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "CevizSoft Remote palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa CevizSoft Remotein asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "CevizSoft Remote palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep CevizSoft Remote background service", "Pidä CevizSoft Remotein taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista CevizSoft Remotein akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show CevizSoft Remote", "Näytä CevizSoft Remote"),
        ...
        ("verify_CevizSoft Remote_password_tip", "Vahvista CevizSoft Remote salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "CevizSoft Remote ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Päivitä CevizSoft Remote Server Pro versioon {} jatkaaksesi."),
        ...
        ("About CevizSoft Remote", "Tietoa CevizSoft Remoteistä"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Päivitä etä-CevizSoft Remote-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena CevizSoft Remote vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, CevizSoft Remote ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, CevizSoft Remote ei enää käytä UDP-porttia 21116, vaan sen sijaan käytetään TCP-porttia 21116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: CevizSoft Remote-palvelimen OSS ei sisällä tätä ominaisuutta."),
