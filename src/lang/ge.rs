...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "CevizSoft Remote ქსელთან დაკავშირება..."),
        ...
        ("install_tip", "ზოგიერთ შემთხვევაში UAC-ის გამო CevizSoft Remote შეიძლება არასწორად მუშაობდეს დაშორებულ კვანძზე. UAC-თან დაკავშირებული პრობლემების თავიდან ასაცილებლად დააჭირეთ ქვემოთ მოცემულ ღილაკს სისტემაში CevizSoft Remote-ის დასაყენებლად."),
        ("Click to upgrade", "დააჭირეთ განახლებისთვის"),
        ("Configure", "კონფიგურაცია"),
        ("config_acc", "თქვენი სამუშაო მაგიდის დისტანციური მართვისთვის უნდა მიანიჭოთ CevizSoft Remote-ს \"წვდომის\" უფლებები"),
        ("config_screen", "სამუშაო მაგიდაზე დისტანციური წვდომისთვის უნდა მიანიჭოთ CevizSoft Remote-ს \"ეკრანის ანაბეჭდის\" უფლებები"),
        ...
        ("android_input_permission_tip1", "იმისთვის, რომ დაშორებულმა მოწყობილობამ შეძლოს თქვენი Android-მოწყობილობის მართვა თაგუნათი ან შეხებით, საჭიროა CevizSoft Remote-ისთვის \"სპეციალური შესაძლებლობების\" სერვისის გამოყენების უფლების მინიჭება."),
        ("android_input_permission_tip2", "გადადით სისტემის პარამეტრების შესაბამის გვერდზე, იპოვეთ და შედით \"დაინსტალირებულ სერვისებში\", ჩართეთ \"CevizSoft Remote Input\" სერვისი."),
        ...
        ("Language", "ენა"),
        ("Keep CevizSoft Remote background service", "CevizSoft Remote-ის ფონური სერვისის შენარჩუნება"),
        ...
        ("Show CevizSoft Remote", "CevizSoft Remote-ის ჩვენება"),
        ...
        ("config_input", "დისტანციური სამუშაო მაგიდის კლავიატურით სამართავად, საჭიროა CevizSoft Remote-ისთვის \"შეყვანის მონიტორინგის\" უფლების მინიჭება."),
        ("config_microphone", "დისტანციურ მხარესთან სასაუბროდ, საჭიროა CevizSoft Remote-ისთვის \"აუდიოს ჩაწერის\" უფლების მინიჭება."),
        ...
        ("still_click_uac_tip", "კვლავ საჭიროა, რომ დისტანციურმა მომხმარებელმა დააჭიროს \"OK\"-ს UAC ფანჯარაში CevizSoft Remote-ის გაშვებისას."),
        ...
        ("verify_CevizSoft Remote_password_tip", "დაადასტურეთ CevizSoft Remote-ის პაროლი"),
        ...
        ("scam_text1", "თუ ტელეფონით ესაუბრებით ვინმეს, ვისაც არ იცნობთ და არ ენდობით, და ის გთხოვთ გამოიყენოთ CevizSoft Remote და გაუშვათ მისი სერვისი, არ გააგრძელოთ და დაუყოვნებლივ შეწყვიტეთ საუბარი."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "განაახლეთ CevizSoft Remote Server Pro ვერსიამდე {} ან უფრო ახალი!"),
        ...
        ("selinux_tip", "თქვენს მოწყობილობაზე ჩართულია SELinux, რამაც შეიძლება ხელი შეუშალოს CevizSoft Remote-ის სწორ მუშაობას მართულ მხარეზე."),
        ("Change view", "ხედი"),
        ...
        ("powered_by_me", "CevizSoft Remote-ზე დაფუძნებული"),
        ...
        ("allow-only-conn-window-open-tip", "დაშვება მხოლოდ მაშინ, როცა CevizSoft Remote-ის ფანჯარა გახსნილია"),
        ...
        ("floating_window_tip", "ეხმარება CevizSoft Remote-ის ფონური სერვისის შენარჩუნებას"),
        ...
        ("About CevizSoft Remote", "CevizSoft Remote-ის შესახებ"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "განაახლეთ CevizSoft Remote კლიენტი ვერსიამდე {} ან უფრო ახალი დისტანციურ მხარეზე!"),
        ...
        ("allow-insecure-tls-fallback-tip", "ნაგულისხმევად CevizSoft Remote ამოწმებს სერვერის სერტიფიკატს TLS-ის გამოყენებისას პროტოკოლებისთვის.\nამ პარამეტრის ჩართვისას CevizSoft Remote გადავა შემოწმების ეტაპის გამოტოვებაზე და გააგრძელებს მუშაობას შემოწმების წარუმატებლობის შემთხვევაში."),
        ("Disable UDP", "UDP-ის გამორთვა"),
        ("disable-udp-tip", "აკონტროლებს, გამოვიყენოთ თუ არა მხოლოდ TCP.\nამ პარამეტრის ჩართვისას CevizSoft Remote აღარ გამოიყენებს UDP 21116-ს, სანაცვლოდ გამოყენებული იქნება TCP 21116."),
        ("server-oss-not-support-tip", "შენიშვნა: CevizSoft Remote server OSS არ მოიცავს ამ ფუნქციას."),
