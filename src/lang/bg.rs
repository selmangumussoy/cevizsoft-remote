...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Свързване с CevizSoft Remote мрежата..."),
        ...
        ("install_tip", "Поради UAC, CevizSoft Remote в някои случай не може да работи правилно за отдалечена достъп. За да заобиколите UAC, моля, натиснете копчето по-долу, за да поставите CevizSoft Remote като системна услуга."),
        ("Click to upgrade", "Натиснете, за да надстроите"),
        ("Configure", "Настройване"),
        ("config_acc", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на CevizSoft Remote права от раздел \"Достъпност\"."),
        ("config_screen", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на CevizSoft Remote права от раздел \"Запис на екрана\"."),
        ...
        ("Discovered", "Открит"),
        ("install_daemon_tip", "За зареждане при стартиране на ОС трябва да инсталирате CevizSoft Remote като системна услуга."),
        ...
        ("android_input_permission_tip1", "За да може отдалечено устройство да управлява вашето Android устройство чрез мишка или допир, трябва да разрешите на CevizSoft Remote да използва услугата \"Достъпност\"."),
        ("android_input_permission_tip2", "Моля, отидете на следващата страница със системни настройки, намерете и въведете [Installed Services], включете услугата [CevizSoft Remote Input]."),
        ...
        ("Language", "Език"),
        ("Keep CevizSoft Remote background service", "Запази CevizSoft Remote фоновата услуга"),
        ("Ignore Battery Optimizations", "Игнорирай оптимизациите на батерията"),
        ("android_open_battery_optimizations_tip", "Ако искате да деактивирате тази функция, моля, отидете на следващата страница с настройки на приложението CevizSoft Remote, намерете и въведете [Battery], премахнете отметката от [Unrestricted]"),
        ...
        ("Show CevizSoft Remote", "Покажи CevizSoft Remote"),
        ...
        ("config_input", "За да управлявате отдалечена среда с клавиатура, трябва да предоставите на CevizSoft Remote право за \"Input Monitoring\"."),
        ("config_microphone", "За да говорите отдалечено, трябва да предоставите на CevizSoft Remote право за \"Запис на звук\"."),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да натисне върху OK в прозореца на UAC при стартиран CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Проверете CevizSoft Remote паролата"),
        ...
        ("scam_text1", "Ако разговаряте по телефона с някой, когото НЕ ПОЗНАВАТЕ и НЯМАТЕ ДОВЕРИЕ, който ви е помолил да използвате CevizSoft Remote и да стартирате услугата, не продължавайте и затворете незабавно."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Моля обновете CevizSoft Remote Server Pro на версия {} или по-нова!"),
        ...
        ("selinux_tip", "SELinux е активиран на вашето устройство, което може да попречи на CevizSoft Remote да работи правилно като контролирана страна."),
        ...
        ("powered_by_me", "Работи с CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Разрешаване на връзка само ако прозорецът на CevizSoft Remote е отворен"),
        ...
        ("floating_window_tip", "Помага за поддържане на фоновата услуга на CevizSoft Remote"),
        ...
        ("About CevizSoft Remote", "За CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Моля, надстройте клиента CevizSoft Remote до версия {} или по-нова от отдалечената страна!"),
        ...
        ("allow-insecure-tls-fallback-tip", "По подразбиране CevizSoft Remote проверява сертификата на сървъра за протоколи, използващи TLS.\nКогато тази опция е активирана, CevizSoft Remote ще пропусне стъпката на проверка и ще продължи в случай на неуспешна проверка."),
        ("Disable UDP", "Забрана на UDP"),
        ("disable-udp-tip", "Управлява дали да се използва само TCP.\nКогато тази опция е активирана, CevizSoft Remote вече няма да използва UDP 21116, а вместо това ще се използва TCP 21116."),
        ("server-oss-not-support-tip", "ЗАБЕЛЕЖКА: CevizSoft Remote server OSS не включва тази функция."),
