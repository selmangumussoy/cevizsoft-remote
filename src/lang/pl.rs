...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "CevizSoft Remote może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować CevizSoft Remote w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić CevizSoft Remote przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić CevizSoft Remote na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [CevizSoft Remote Input]."),
        ...
        ("Language", "Język"),
        ("Keep CevizSoft Remote background service", "Zachowaj usługę CevizSoft Remote w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji CevizSoft Remote, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show CevizSoft Remote", "Pokaż CevizSoft Remote"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji CevizSoft Remote uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać CevizSoft Remote uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z CevizSoft Remote w Twojej sieci."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Weryfikuj hasło CevizSoft Remote"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu CevizSoft Remote - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Proszę zaktualizować CevizSoft Remote Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu CevizSoft Remote po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno CevizSoft Remote jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę CevizSoft Remote w tle"),
        ...
        ("About CevizSoft Remote", "O programie"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Proszę zaktualizować zdalny klient CevizSoft Remote do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie CevizSoft Remote weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, CevizSoft Remote pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, CevizSoft Remote nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS CevizSoft Remote nie obsługuje tej funkcji."),
