...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k CevizSoft Remote síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), CevizSoft Remote v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak CevizSoft Remote do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci CevizSoft Remote udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci CevizSoft Remote udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby CevizSoft Remote mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [CevizSoft Remote vstup]."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep CevizSoft Remote background service", "Zachovat službu CevizSoft Remote na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace CevizSoft Remote, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show CevizSoft Remote", "Zobrazit CevizSoft Remote"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění CevizSoft Remote \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění CevizSoft Remote \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného CevizSoft Remoteu."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Ověření hesla CevizSoft Remote"),
        ...
        ("scam_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby CevizSoft Remote a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Aktualizujte prosím CevizSoft Remote Server Pro na verzi {} nebo novější!"),
        ...
        ("selinux_tip", "Na vašem zařízení je povolen SELinux, což může bránit správnému běhu CevizSoft Remoteu jako řízené strany."),
        ...
        ("powered_by_me", "Poháněno společností CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Povolit připojení pouze v případě, že je otevřené okno CevizSoft Remote"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu CevizSoft Remote na pozadí"),
        ...
        ("About CevizSoft Remote", "O CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Upgradujte prosím klienta CevizSoft Remote na verzi {} nebo novější na vzdálené straně!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Ve výchozím nastavení CevizSoft Remote ověřuje certifikát serveru u protokolů používajících TLS.\nKdyž je tato možnost povolena, CevizSoft Remote v případě selhání ověření přejde k přeskočení kroku ověření a bude pokračovat."),
        ("Disable UDP", "Zakázat UDP"),
        ("disable-udp-tip", "Určuje, zda se má používat pouze TCP.\nKdyž je tato možnost povolena, CevizSoft Remote již nebude používat UDP 21116, místo toho se použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: CevizSoft Remote server OSS tuto funkci neobsahuje."),
