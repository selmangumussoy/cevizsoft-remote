...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do CevizSoft Remote..."),
        ...
        ("install_tip", "Devido ao UAC, o CevizSoft Remote não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o CevizSoft Remote no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao CevizSoft Remote permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao CevizSoft Remote permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o CevizSoft Remote use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [CevizSoft Remote Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep CevizSoft Remote background service", "Manter o serviço CevizSoft Remote em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação CevizSoft Remote, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show CevizSoft Remote", "Mostrar CevizSoft Remote"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao CevizSoft Remote as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao CevizSoft Remote as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do CevizSoft Remote em execução."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Verificar palavra-passe do CevizSoft Remote"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o CevizSoft Remote e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Atualize o CevizSoft Remote Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o CevizSoft Remote de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do CevizSoft Remote estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do CevizSoft Remote"),
        ...
        ("About CevizSoft Remote", "Sobre o CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Atualize o cliente CevizSoft Remote para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o CevizSoft Remote verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o CevizSoft Remote recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o CevizSoft Remote deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o CevizSoft Remote server OSS não inclui esta funcionalidade."),
