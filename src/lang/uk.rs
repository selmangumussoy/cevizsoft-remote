...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі CevizSoft Remote..."),
        ...
        ("install_tip", "Через UAC, в деяких випадках CevizSoft Remote може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення CevizSoft Remote в системі"),
        ("Click to upgrade", "Натисніть, щоб перевірити наявність оновлень"),
        ("Configure", "Налаштувати"),
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати CevizSoft Remote дозволи \"Спеціальні можливості\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці, вам необхідно надати CevizSoft Remote дозволи на \"Запис екрана\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або дотику, вам необхідно дозволити CevizSoft Remote використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Будь ласка, перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [CevizSoft Remote Input]."),
        ...
        ("Language", "Мова"),
        ("Keep CevizSoft Remote background service", "Зберегти фонову службу CevizSoft Remote"),
        ...
        ("Show CevizSoft Remote", "Показати CevizSoft Remote"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати CevizSoft Remote дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати CevizSoft Remote дозвіл на \"Запис аудіо\""),
        ...
        ("verify_CevizSoft Remote_password_tip", "Перевірте пароль CevizSoft Remote"),
        ...
        ("scam_text1", "Якщо ви розмовляєте по телефону з кимось, кого НЕ ЗНАЄТЕ чи кому НЕ ДОВІРЯЄТЕ, і ця особа хоче, щоб ви використали CevizSoft Remote та запустили службу, не робіть цього та негайно завершіть дзвінок."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Будь ласка, оновіть CevizSoft Remote Server Pro до версії {} чи новіше!"),
        ...
        ("selinux_tip", "SELinux увімкнено на вашому пристрої, що може ускладнити для іншої сторони віддалене керування за допомогою CevizSoft Remote."),
        ...
        ("powered_by_me", "На основі CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Дозволяти підключення лише коли відкрите вікно CevizSoft Remote"),
        ...
        ("floating_window_tip", "Допомагає зберегти фонову службу CevizSoft Remote"),
        ...
        ("About CevizSoft Remote", "Про CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Будь ласка, оновіть CevizSoft Remote клієнт на віддаленому пристрої до версії {} чи новіше!"),
        ...
        ("allow-insecure-tls-fallback-tip", "За замовчуванням CevizSoft Remote перевіряє сертифікат сервера для протоколів, які використовують TLS.\nКоли цей параметр увімкнено, у разі помилки перевірки CevizSoft Remote пропустить крок перевірки та продовжить."),
        ("Disable UDP", "Вимкнути UDP"),
        ("disable-udp-tip", "Визначає, чи використовувати лише TCP.\nКоли цей параметр увімкнено, CevizSoft Remote більше не використовуватиме UDP 21116, замість нього буде використано TCP 21116."),
        ("server-oss-not-support-tip", "ПРИМІТКА: сервер CevizSoft Remote OSS не містить цієї функції."),
