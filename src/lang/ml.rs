...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "സെറ്റിംഗ്സിൽ CevizSoft Remote കണ്ടെത്തി അത് ഓൺ ചെയ്യുക."),
        ...
        ("Language", "ഭാഷ"),
        ("Keep CevizSoft Remote background service", "CevizSoft Remote ബാക്ക്ഗ്രൗണ്ടിൽ പ്രവർത്തിപ്പിക്കുക"),
        ...
        ("Show CevizSoft Remote", "CevizSoft Remote കാണിക്കുക"),
        ("This PC", "ഈ പിസി"),
        ("or", "അല്ലെങ്കിൽ"),
        ...
        ("verify_CevizSoft Remote_password_tip", "CevizSoft Remote പാസ്‌വേഡ് പരിശോധിക്കുക"),
        ...
        ("scam_text1", "നിങ്ങൾക്ക് പരിചയമില്ലാത്ത ആരെങ്കിലും CevizSoft Remote ഉപയോഗിക്കാൻ ആവശ്യപ്പെട്ടാൽ ഉടൻ കണക്ഷൻ വിച്ഛേദിക്കുക."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "സെർവർ പ്രോ {} ലേക്ക് അപ്‌ഗ്രേഡ് ചെയ്യുക"),
        ...
        ("allow-only-conn-window-open-tip", "CevizSoft Remote വിൻഡോ തുറന്നിരിക്കുമ്പോൾ മാത്രം കണക്ഷൻ അനുവദിക്കുക"),
        ...
        ("floating_window_tip", "ബാക്ക്ഗ്രൗണ്ടിലാണെങ്കിലും CevizSoft Remote കാണിക്കുക"),
        ...
        ("About CevizSoft Remote", "CevizSoft Remote-നെ കുറിച്ച്"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "റിമോട്ട് പതിപ്പ് {} ലേക്ക് മാറ്റുക"),
