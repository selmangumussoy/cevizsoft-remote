...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do CevizSoft Remote..."),
        ...
        ("install_tip", "Devido ao UAC, o CevizSoft Remote não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o CevizSoft Remote no sistema."),
        ("Click to upgrade", "Iniciar atualização"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao CevizSoft Remote permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao CevizSoft Remote permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o CevizSoft Remote use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [CevizSoft Remote Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep CevizSoft Remote background service", "Manter o serviço do CevizSoft Remote executando em segundo plano"),
        ...
        ("Show CevizSoft Remote", "Exibir CevizSoft Remote"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do CevizSoft Remote."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do CevizSoft Remote."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Verifique a senha do CevizSoft Remote"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o CevizSoft Remote e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Atualize o CevizSoft Remote Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o CevizSoft Remote funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do CevizSoft Remote estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço CevizSoft Remote em segundo plano"),
        ...
        ("About CevizSoft Remote", "Sobre CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Atualize o cliente CevizSoft Remote para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o CevizSoft Remote verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o CevizSoft Remote ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o CevizSoft Remote não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor CevizSoft Remote OSS não inclui este recurso."),
