...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "कृपया सिस्टम सेटिंग में CevizSoft Remote खोजें और इसे चालू करें।"),
        ...
        ("Language", "भाषा"),
        ("Keep CevizSoft Remote background service", "CevizSoft Remote बैकग्राउंड सेवा चालू रखें"),
        ...
        ("Show CevizSoft Remote", "CevizSoft Remote दिखाएं"),
        ("This PC", "यह PC"),
        ("or", "या"),
        ...
        ("verify_CevizSoft Remote_password_tip", "CevizSoft Remote पासवर्ड सत्यापित करें"),
        ...
        ("scam_text1", "यदि आप किसी ऐसे व्यक्ति से बात कर रहे हैं जिसे आप नहीं जानते और जिसने आपसे CevizSoft Remote उपयोग करने को कहा है, तो तुरंत डिस्कनेक्ट कर दें।"),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "CevizSoft Remote सर्वर प्रो को संस्करण {} में अपग्रेड करें"),
        ...
        ("allow-only-conn-window-open-tip", "केवल तभी कनेक्शन की अनुमति दें जब CevizSoft Remote विंडो खुली हो"),
        ...
        ("floating_window_tip", "बैकग्राउंड में रहने के दौरान CevizSoft Remote को दिखाएं"),
        ...
        ("About CevizSoft Remote", "CevizSoft Remote के बारे में"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "रिमोट CevizSoft Remote क्लाइंट को संस्करण {} में अपग्रेड करें"),
