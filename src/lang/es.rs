...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red CevizSoft Remote en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que CevizSoft Remote no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar CevizSoft Remote a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a CevizSoft Remote de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a CevizSoft Remote de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que CevizSoft Remote use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [CevizSoft Remote Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep CevizSoft Remote background service", "Dejar CevizSoft Remote como Servicio en 2do plano"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a CevizSoft Remote permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a CevizSoft Remote permisos de \"Grabar Audio\"."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Verificar la contraseña de CevizSoft Remote"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses CevizSoft Remote e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "¡Por favor, actualiza CevizSoft Remote Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que CevizSoft Remote no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de CevizSoft Remote"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de CevizSoft Remote de fondo"),
        ...
        ("About CevizSoft Remote", "Acerca de CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Por favor, actualiza el cliente CevizSoft Remote a la versión {} o superior en el lado remoto"),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, CevizSoft Remote verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, CevizSoft Remote volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, CevizSoft Remote no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: El servidor CevizSoft Remote OSS no incluye esta característica."),
