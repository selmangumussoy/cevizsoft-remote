...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Konektante al la reto CevizSoft Remote..."),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron aŭ registri la ekranon. Bonvolu alkliku la butonon malsupre por instali CevizSoft Remote sur la operaciumo por eviti la demando supre."),
        ("Click to upgrade", "Alklaki por plibonigi"),
        ("Configure", "Konfiguri"),
        ("config_acc", "Por uzi vian foran aparaton, bonvolu doni la permeson \"alirebleco\" al CevizSoft Remote."),
        ("config_screen", "Por uzi vian foran aparaton, bonvolu doni la permeson \"ekranregistrado\" al CevizSoft Remote."),
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aŭ tuŝo, vi devas permesi al CevizSoft Remote uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paĝo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], ŝalti la servon [CevizSoft Remote Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep CevizSoft Remote background service", "Tenu CevizSoft Remote fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malŝalti ĉi tiun funkcion, bonvolu iri al la sekva paĝo de agordoj de la aplikaĵo de CevizSoft Remote, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ...
        ("Show CevizSoft Remote", "Montri CevizSoft Remote"),
        ...
        ("config_input", "Por kontroli la foran labortablon per klavaro, vi devas doni al CevizSoft Remote permeson \"Eniga Monitorado\"."),
        ("config_microphone", "Por paroli fore, vi devas doni al CevizSoft Remote permeson \"Registri Sonon\"."),
        ...
        ("still_click_uac_tip", "Ankoraŭ postulas ke la fora uzanto alklaku Bone en la UAC-fenestro de la funkcianta CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Kontroli CevizSoft Remote-pasvorton"),
        ...
        ("scam_text1", "Se vi telefonas kun iu kiun vi NE konas KAJ FIDAS, kiu petis vin uzi CevizSoft Remote kaj komenci la servon, ne daŭrigu kaj tuj malŝaltu la telefonon."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Bonvolu ĝisdatigi CevizSoft Remote Server Pro al versio {} aŭ pli nova!"),
        ...
        ("selinux_tip", "SELinux estas ebligita sur via aparato, kio povas malhelpi CevizSoft Remote funkcii ĝuste kiel kontrolata flanko."),
        ...
        ("powered_by_me", "Funkciigita de CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Permesi konekton nur se la fenestro de CevizSoft Remote estas malfermita"),
        ...
        ("floating_window_tip", "Ĝi helpas teni la fonan servon de CevizSoft Remote"),
        ...
        ("About CevizSoft Remote", "Pri CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Bonvolu ĝisdatigi la CevizSoft Remote-klienton al versio {} aŭ pli nova ĉe la fora flanko!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Implicite, CevizSoft Remote kontrolas la servilan atestilon por protokoloj uzantaj TLS.\nKun ĉi tiu opcio ebligita, CevizSoft Remote retrokadros al preterlaso de la kontrola paŝo kaj daŭrigos en kazo de kontrola malsukceso."),
        ("Disable UDP", "Malebligi UDP"),
        ("disable-udp-tip", "Regas ĉu uzi nur TCP.\nKiam ĉi tiu opcio estas ebligita, CevizSoft Remote ne plu uzos UDP 21116, TCP 21116 estos uzata anstataŭe."),
        ("server-oss-not-support-tip", "NOTU: CevizSoft Remote-servilo OSS ne inkluzivas ĉi tiun funkcion."),
