...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete CevizSoft Remote..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), CevizSoft Remote diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare CevizSoft Remote a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a CevizSoft Remote su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a CevizSoft Remote su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a CevizSoft Remote de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada CevizSoft Remote]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep CevizSoft Remote background service", "Mantene su servìtziu de CevizSoft Remote in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione CevizSoft Remote, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("Show CevizSoft Remote", "Mustra CevizSoft Remote"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ("Elevate", "Cresche"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a CevizSoft Remote sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a CevizSoft Remote."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Cunfirma sa crae de CevizSoft Remote"),
        ...
        ("Exit", "Essi dae CevizSoft Remote"),
        ("Open", "Aberi CevizSoft Remote"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare CevizSoft Remote e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Atualiza CevizSoft Remote Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de CevizSoft Remote comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana CevizSoft Remote est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de CevizSoft Remote"),
        ...
        ("About CevizSoft Remote", "Informatziones subra de CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Atualiza su cliente CevizSoft Remote remotu a sa versione {} o prus noa!"),
        ...
        ("allow-insecure-tls-fallback-tip", "De manera predefinida, CevizSoft Remote averguat su certificadu de su serbidore pro sos protocollos chi impreant TLS.\nCun custa optzione ativada, CevizSoft Remote at a brincare s'averguada e at a sighire in casu de faddina de averguada."),
        ("Disable UDP", "Disabìlita UDP"),
        ("disable-udp-tip", "Controllat si impreare petzi su TCP.\nCun custa optzione ativada, CevizSoft Remote no at a impreare prus sa UDP 21116, ma at a impreare sa TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: su serbidore OSS de CevizSoft Remote non includet custa funtzione."),
