...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "CevizSoft Remotei võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa CevizSoft Remote mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et CevizSoft Remote oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb CevizSoft Remoteile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb CevizSoft Remoteile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma CevizSoft Remoteile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [CevizSoft Remote Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep CevizSoft Remote background service", "Säilita CevizSoft Remotei taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele CevizSoft Remotei rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show CevizSoft Remote", "Kuva CevizSoft Remote"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma CevizSoft Remoteile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma CevizSoft Remoteile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud CevizSoft Remotei kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Kinnita CevizSoft Remotei parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul CevizSoft Remotei kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Palun täienda CevizSoft Remote Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib CevizSoft Remoteil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb CevizSoft Remoteil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui CevizSoft Remotei aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada CevizSoft Remotei taustateenust."),
        ...
        ("About CevizSoft Remote", "CevizSoft Remotei teave"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Täiendage CevizSoft Remotei klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib CevizSoft Remote TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab CevizSoft Remote kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta CevizSoft Remote enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: CevizSoft Remotei serveri OSS ei sisalda seda funktsiooni."),
