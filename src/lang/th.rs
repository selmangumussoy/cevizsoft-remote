...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "กำลังเชื่อมต่อไปยังเครือข่าย CevizSoft Remote..."),
        ...
        ("install_tip", "เนื่องด้วยข้อจำกัดของการใช้งาน UAC ทำให้ CevizSoft Remote ไม่สามารถทำงานได้ปกติในฝั่งปลายทางในบางครั้ง เพื่อหลีกเลี่ยงข้อจำกัดของ UAC กรุณากดปุ่มด้านล่างเพื่อติดตั้ง CevizSoft Remote ไปยังระบบของคุณ"),
        ("Click to upgrade", "คลิกเพื่ออัปเกรด"),
        ("Configure", "ปรับแต่งค่า"),
        ("config_acc", "เพื่อที่จะควบคุมเดสก์ท็อปปลายทางของคุณ คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การเข้าถึง\" ให้แก่ CevizSoft Remote"),
        ("config_screen", "เพื่อที่จะควบคุมเดสก์ท็อปปลายทางของคุณ คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การบันทึกภาพหน้าจอ\" ให้แก่ CevizSoft Remote"),
        ...
        ("android_input_permission_tip1", "ในการที่จะอนุญาตให้เครื่องปลายทางควบคุมอุปกรณ์แอนดรอยด์ของคุณโดยใช้เมาส์หรือการสัมผัส คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การเข้าถึง\" ให้แก่เซอร์วิสของ CevizSoft Remote"),
        ("android_input_permission_tip2", "กรุณาไปยังหน้าตั้งค่าถัดไป ค้นหาและเข้าไปยัง [เซอร์วิสที่ถูกติดตั้ง] และเปิดการใช้งานเซอร์วิส [อินพุท CevizSoft Remote]"),
        ...
        ("Turned off", "ปิด"),
        ("Language", "ภาษา"),
        ("Keep CevizSoft Remote background service", "คงสถานะการทำงานเบื้องหลังของเซอร์วิส CevizSoft Remote"),
        ("Ignore Battery Optimizations", "เพิกเฉยการตั้งค่าการใช้งาน Battery Optimization"),
        ("android_open_battery_optimizations_tip", "หากคุณต้องการปิดการใช้งานฟีเจอร์นี้ กรุณาไปยังหน้าตั้งค่าในแอปพลิเคชัน CevizSoft Remote ค้นหาหัวข้อ [Battery] และยกเลิกการเลือกรายการ [Unrestricted]"),
        ...
        ("Show CevizSoft Remote", "แสดง CevizSoft Remote"),
        ...
        ("config_input", "เพื่อที่จะควบคุมเครื่องเดสก์ท็อปปลายทางด้วยคีย์บอร์ด คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การตรวจสอบ Input\" ให้แก่ CevizSoft Remote"),
        ("config_microphone", "เพื่อที่จะส่งเสียงพูดไปยังปลายทาง คุณจำเป็นจะต้องอนุญาตสิทธิ์ \"การบันทึกเสียง\" ให้แก่ CevizSoft Remote"),
        ...
        ("still_click_uac_tip", "ผู้ใช้งานปลายทางยังจำเป็นที่จะต้องกดปุ่ม ตกลง บนหน้าต่าง UAC ของ CevizSoft Remote"),
        ...
        ("verify_CevizSoft Remote_password_tip", "ยืนยันความถูกต้องรหัสผ่านของ CevizSoft Remote"),
        ...
        ("scam_text1", "ถ้าคุณกำลังคุยโทรศัพท์กับคนที่คุณไม่รู้จักและไม่ไว้ใจ และคนๆนั้นกำลังขอให้คุณเปิดใช้งาน CevizSoft Remote อย่าทำตามและรีบวางสายในทันที"),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "กรุณาอัปเดต CevizSoft Remote Server Pro ไปยังเวอร์ชัน {} หรือใหม่กว่า!"),
        ...
        ("selinux_tip", "SELinux ถูกเปิดใช้งานบนอุปกรณ์ของคุณ ซึ่งอาจทำให้ CevizSoft Remote ทำงานเป็นฝ่ายถูกควบคุมได้ไม่สมบูรณ์"),
        ...
        ("powered_by_me", "ขับเคลื่อนโดย CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "อนุญาตการเชื่อมต่อเฉพาะเมื่อหน้าต่าง CevizSoft Remote เปิดอยู่"),
        ...
        ("floating_window_tip", "ช่วยให้บริการเบื้องหลังของ CevizSoft Remote ทำงานต่อเนื่อง"),
        ...
        ("About CevizSoft Remote", "เกี่ยวกับ CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "กรุณาอัปเดต CevizSoft Remote ไคลเอนต์ไปยังเวอร์ชัน {} หรือใหม่กว่าที่ฝั่งปลายทาง!"),
        ...
        ("allow-insecure-tls-fallback-tip", "โดยค่าเริ่มต้น CevizSoft Remote จะตรวจสอบใบรับรองของเซิร์ฟเวอร์สำหรับโปรโตคอลที่ใช้ TLS\nเมื่อเปิดใช้งานตัวเลือกนี้ CevizSoft Remote จะย้อนกลับไปข้ามขั้นตอนการตรวจสอบและดำเนินการต่อในกรณีที่การตรวจสอบล้มเหลว"),
        ("Disable UDP", "ปิดใช้งาน UDP"),
        ("disable-udp-tip", "ควบคุมว่าจะใช้ TCP เท่านั้นหรือไม่\nเมื่อเปิดใช้งานตัวเลือกนี้ CevizSoft Remote จะไม่ใช้ UDP 21116 อีกต่อไป และจะใช้ TCP 21116 แทน"),
        ("server-oss-not-support-tip", "หมายเหตุ: CevizSoft Remote server OSS ไม่มีคุณสมบัตินี้"),
