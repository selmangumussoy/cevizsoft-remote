...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, CevizSoft Remote bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, CevizSoft Remote'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için CevizSoft Remote'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için CevizSoft Remote'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, CevizSoft Remote'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [CevizSoft Remote Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep CevizSoft Remote background service", "CevizSoft Remote arka plan hizmetini sürdürün"),
        ("Ignore Battery Optimizations", "Pil Optimizasyonlarını Yoksay"),
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki CevizSoft Remote uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("Show CevizSoft Remote", "CevizSoft Remote'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ("Elevate", "Yükseltme"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için CevizSoft Remote'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için CevizSoft Remote'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan CevizSoft Remote'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_CevizSoft Remote_password_tip", "CevizSoft Remote parolasını doğrulayın"),
        ...
        ("scam_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden CevizSoft Remote'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Lütfen CevizSoft Remote Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, CevizSoft Remote'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("powered_by_me", "CevizSoft Remote tarafından desteklenmektedir"),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca CevizSoft Remote penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "CevizSoft Remote arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About CevizSoft Remote", "CevizSoft Remote Hakkında"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Lütfen uzak tarafta CevizSoft Remote istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, CevizSoft Remote sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda CevizSoft Remote doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, CevizSoft Remote artık UDP 21116'yı kullanmayacak, bunun yerine TCP 21116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: CevizSoft Remote sunucu OSS'si bu özelliği içermemektedir."),
