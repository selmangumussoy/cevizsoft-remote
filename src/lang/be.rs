...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ідзе падключэнне да сеткі CevizSoft Remote..."),
        ...
        ("install_tip", "У некаторых выпадках з-за UAC, CevizSoft Remote можа працаваць на баку абанента неадпаведным чынам. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўсталявання CevizSoft Remote у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам трэба дазволіць CevizSoft Remote правы \"доступу\""),
        ("config_screen", "Для аддаленага доступу да працоўнага стала вам трэба даць CevizSoft Remote правы \"здымку экрана\"."),
        ...
        ("android_input_permission_tip1", "Каб аддаленая прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, трэба дазволіць CevizSoft Remote выкарыстоўваць службу \"Спецыяльныя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і перайдзіце ва \"Усталяваныя службы\", уключыце службу \"CevizSoft Remote Input\"."),
        ...
        ("Language", "Мова"),
        ("Keep CevizSoft Remote background service", "Захаваць фонавую службу CevizSoft Remote"),
        ...
        ("Show CevizSoft Remote", "Паказаць CevizSoft Remote"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, трэба дазволіць CevizSoft Remote \"Маніторынг уводу\"."),
        ("config_microphone", "Каб размаўляць з абанентам, трэба дазволіць CevizSoft Remote запіс аўдыя."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб абанент націснуў \"OK\" ў акне UAC пры запуску CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Пацвердзіць пароль CevizSoft Remote"),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсьці НЕЗНАЁМЫМ і каму вы НЕ ДАВЕРАЕЦЕ, і гэта асоба просіць вас выкарыстаць CevizSoft Remote і запусціць яго службу, не працягвайце і неадкладна скончыце размову."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Абнавіце CevizSoft Remote Server Pro да версіі {} або навейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа ствараць перашкоды ў працы CevizSoft Remote на баку абанента."),
        ("Change view", "Рэжым"),
        ...
        ("powered_by_me", "Заснавана на CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць падключэнне толькі пры адкрытым акне CevizSoft Remote"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу CevizSoft Remote"),
        ...
        ("About CevizSoft Remote", "Пра CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Абнавіце кліент CevizSoft Remote да версіі {} або навейшай на баку абанента!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Стандартна CevizSoft Remote правярае сертыфікат сервера на наяўнасць пратаколаў, якія выкарыстоўваюць TLS.\nКалі гэта функцыя ўключана, CevizSoft Remote прапусціць дадзены этап і працягне працу ў выпадку няўдалай праверкі."),
        ("Disable UDP", "Выключыць UDP"),
        ("disable-udp-tip", "Вызначае, ці варта выкарыстоўваць толькі TCP.\nКалі ўключана, CevizSoft Remote не будзе выкарыстоўваць UDP 21116, замест чаго будзе выкарыстоўвацца TCP 21116."),
        ("server-oss-not-support-tip", "ЗАЎВАГА! у OSS-серверы CevizSoft Remote гэта функцыя адсутнічае."),
