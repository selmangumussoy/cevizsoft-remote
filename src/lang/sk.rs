...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Pripájam sa na CevizSoft Remote server..."),
        ...
        ("install_tip", "V niektorých prípadoch CevizSoft Remote nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ("Click to upgrade", "Kliknutím nainštalujete aktualizáciu"),
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii CevizSoft Remote udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii CevizSoft Remote udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii CevizSoft Remote udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [CevizSoft Remote Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep CevizSoft Remote background service", "Ponechať službu CevizSoft Remote na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovať optimalizácie batérie"),
        ("android_open_battery_optimizations_tip", "Ak chcete túto funkciu vypnúť, prejdite na ďalšiu stránku nastavení CevizSoft Remoteu, vyhľadajte a zadajte položku [Batéria], zrušte začiarknutie položky [Neobmedzené]."),
        ...
        ("Show CevizSoft Remote", "Zobraziť CevizSoft Remote"),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie CevizSoft Remote \"Sledovanie vstupu\"."),
        ("config_microphone", "Ak chcete hovoriť na diaľku, musíte CevizSoft Remoteu udeliť povolenie \"Nahrávať zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Overenie hesla CevizSoft Remote"),
        ...
        ("scam_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie CevizSoft Remote, nepokračujte v hovore a okamžite zaveste."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Aktualizujte CevizSoft Remote Server Pro na verziu {} alebo novšiu!"),
        ...
        ("selinux_tip", "Na vašom zariadení je povolený SELinux, čo môže brániť správnemu spusteniu CevizSoft Remoteu ako spravovanej strany."),
        ...
        ("powered_by_me", "Poháňané aplikáciou CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie CevizSoft Remote"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu CevizSoft Remote na pozadí"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Aktualizujte klienta CevizSoft Remote na verziu {} alebo novšiu na vzdialenej strane!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Štandardne CevizSoft Remote overuje certifikát servera pre protokoly používajúce TLS.\nS touto možnosťou CevizSoft Remote v prípade zlyhania overenia preskočí krok overovania a bude pokračovať."),
        ("Disable UDP", "Vypnúť UDP"),
        ("disable-udp-tip", "Určuje, či sa má používať iba TCP.\nKeď je táto možnosť povolená, CevizSoft Remote už nebude používať UDP 21116, namiesto neho sa použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: CevizSoft Remote server OSS túto funkciu neobsahuje."),
