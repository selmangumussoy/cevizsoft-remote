...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Për shkak të UAC, CevizSoft Remote nuk mund të punoj sic duhet si nje remote në distancë në disa raste. Për të shamngur UAC, ju lutem klikoni butonin më poshtë për të instaluar CevizSoft Remote në sistem."),
        ("Click to upgrade", "Klikoni për përmirësim"),
        ("Configure", "Koniguro"),
        ("config_acc", "Për të kontrolluar Desktopin tuaj nga distanca, duhet të jepni leje CevizSoft Remote \"Aksesueshmëri\"."),
        ("config_screen", "Për të aksesuar Desktopin tuaj nga distanca, duhet ti jepni lejet CevizSoft Remote \"Regjistrimin e ekranit\"."),
        ...
        ("android_input_permission_tip1", "Në mënyrë që një pajisje në distancë të kontrollojë pajisjen tuaj Android nëpërmjet mausit ose prekjes, duhet të lejoni CevizSoft Remote të përdorë shërbimin."),
        ("android_input_permission_tip2", "Ju lutemi shkoni në faqen tjetër të cilësimeve të sistemit, gjeni dhe shtypni [Shërbimet e Instaluara], aktivizoni shërbimin [CevizSoft Remote Input]"),
        ...
        ("Turned off", "I fikur"),
        ("Language", "Gjuha"),
        ("Keep CevizSoft Remote background service", "Mbaje shërbimin e sfondit të CevizSoft Remote"),
        ("Ignore Battery Optimizations", "Injoro optimizimet e baterisë"),
        ("android_open_battery_optimizations_tip", "Nëse dëshironi ta çaktivizoni këtë veçori, ju lutemi shkoni te faqja tjetër e cilësimeve të aplikacionit CevizSoft Remote, gjeni dhe shtypni [Batteri], hiqni zgjedhjen [Te pakufizuara]"),
        ...
        ("Show CevizSoft Remote", "Shfaq CevizSoft Remote"),
        ("This PC", "Ky PC"),
        ("or", "ose"),
        ("Elevate", "Ngritja"),
        ...
        ("config_input", "Për të kontrolluar desktopin në distancë me tastierë, duhet t'i jepni CevizSoft Remote lejen \"Monitorimi i hyrjes\"."),
        ("config_microphone", "Për të folur në distancë, duhet t'i jepni CevizSoft Remote lejen \"Regjistro audio\"."),
        ...
        ("still_click_uac_tip", "Ende kërkon që përdoruesi në distancë të klikojë OK në dritaren UAC të CevizSoft Remote që po funksionon."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Verifiko fjalëkalimin e CevizSoft Remote"),
        ...
        ("scam_text1", "Nëse jeni në telefon me dikë që NUK e njihni DHE NUK i BESONI, i cili ju ka kërkuar të përdorni CevizSoft Remote dhe të nisni shërbimin, mos vazhdoni dhe mbyllni telefonin menjëherë."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Ju lutemi përmirësoni CevizSoft Remote Server Pro në versionin {} ose më të ri!"),
        ...
        ("selinux_tip", "SELinux është i aktivizuar në pajisjen tuaj, gjë që mund të pengojë CevizSoft Remote të funksionojë siç duhet si anë e kontrolluar."),
        ...
        ("powered_by_me", "Mundësuar nga CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Lejo lidhjen vetëm nëse dritarja e CevizSoft Remote është e hapur"),
        ...
        ("floating_window_tip", "Ndihmon për të mbajtur shërbimin në sfond të CevizSoft Remote"),
        ...
        ("About CevizSoft Remote", "Rreth CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Ju lutemi përmirësoni klientin CevizSoft Remote në versionin {} ose më të ri në anën në distancë!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Si parazgjedhje, CevizSoft Remote verifikon certifikatën e serverit për protokollet që përdorin TLS.\nMe këtë opsion të aktivizuar, CevizSoft Remote do të kthehet duke kapërcyer hapin e verifikimit dhe do të vazhdojë në rast dështimi të verifikimit."),
        ("Disable UDP", "Çaktivizo UDP"),
        ("disable-udp-tip", "Kontrollon nëse do të përdoret vetëm TCP.\nKur ky opsion është i aktivizuar, CevizSoft Remote nuk do ta përdorë më UDP 21116, në vend të tij do të përdoret TCP 21116."),
        ("server-oss-not-support-tip", "SHËNIM: CevizSoft Remote server OSS nuk e përfshin këtë veçori."),
