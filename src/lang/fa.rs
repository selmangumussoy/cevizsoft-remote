...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای CevizSoft Remote برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز CevizSoft Remote برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز CevizSoft Remote برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "استفاده کند \"Accessibility\" اجازه دهید از ویژگی CevizSoft Remote شما را از طریق ماوس یا صفحه ی لمسی کنترل کند، باید به Android برای اینکه یک دستگاه از راه دور بتواند دستگاه"),
        ("android_input_permission_tip2", "را پیدا کنید و فعال نمایید \"CevizSoft Remote Input\" بشوید ، سپس گزینه \"Installed Services\" وارد قسمت \"Accessibility\" در صفحه تنظیمات "),
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep CevizSoft Remote background service", "را در پس زمینه نگه دارید CevizSoft Remote سرویس"),
        ...
        ("Show CevizSoft Remote", "CevizSoft Remote نمایش"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز CevizSoft Remote \"Input Monitoring\" را بدهید."),
        ("config_microphone", "را بدهید. CevizSoft Remote \"Record Audio\" برای صحبت از راه دور، باید مجوز"),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای CevizSoft Remote کلیک کند."),
        ...
        ("verify_CevizSoft Remote_password_tip", "رمز عبور CevizSoft Remote را تأیید کنید"),
        ...
        ("scam_text1", "استفاده کنید و سرویس را راه‌اندازی کنید، صحبت می‌کنید، ادامه ندهید و بلافاصله تلفن را قطع کنید CevizSoft Remote اگر با شخصی که نمی‌شناسید و به او اعتماد ندارید و از شما خواسته است از"),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید CevizSoft Remote Server Pro لظفا"),
        ...
        ("selinux_tip", "به عنوان کنترل شده جلوگیری کند CevizSoft Remote روی دستگاه شما فعال است ، که ممکن است از اجرای صحیح SELinux"),
        ...
        ("allow-only-conn-window-open-tip", "باز است اتصال برقرار شود CevizSoft Remote زمانی که"),
        ...
        ("floating_window_tip", "کمک می کند CevizSoft Remote این به حفظ سرویس پس زمینه"),
        ...
        ("About CevizSoft Remote", "CevizSoft Remote درباره"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "لطفاً CevizSoft Remote را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
        ...
        ("allow-insecure-tls-fallback-tip", "به‌طور پیش‌فرض، CevizSoft Remote گواهی سرور را برای پروتکل‌ها با استفاده از TLS تأیید می‌کند.\nبا فعال بودن این گزینه، CevizSoft Remote دوباره مرحله تأیید را رد می‌کند و در صورت عدم موفقیت تأیید ادامه می‌دهد."),
        ("Disable UDP", "UDP غیر فعال کردن"),
        ("disable-udp-tip", "کنترل می کند که آیا فقط از TCP استفاده شود یا خیر.\nوقتی این گزینه فعال باشد، CevizSoft Remote دیگر از UDP 21116 استفاده نمی کند، به جای آن از TCP 21116 استفاده می شود."),
        ("server-oss-not-support-tip", "توجه: سرور CevizSoft Remote OSS این ویژگی را ندارد."),
