...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連線到 CevizSoft Remote 網路..."),
        ("Enable service", "啟用服務"),
        ("Start service", "啟動服務"),
        ...
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC 會導致 CevizSoft Remote 在某些情況下無法正常作為遠端端點運作。若要避開 UAC，請點選下方按鈕將 CevizSoft Remote 安裝到系統中。"),
        ("Click to upgrade", "點選以升級"),
        ("Configure", "設定"),
        ("config_acc", "為了遠端控制您的桌面，您需要授予 CevizSoft Remote「無障礙功能」權限。"),
        ("config_screen", "為了遠端存取您的桌面，您需要授予 CevizSoft Remote「螢幕錄製」權限。"),
        ("Installing ...", "正在安裝..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ...
        ("android_input_permission_tip1", "為了讓遠端裝置能夠透過滑鼠或觸控控制您的 Android 裝置，您需要允許 CevizSoft Remote 使用「輔助功能」服務。"),
        ("android_input_permission_tip2", "請前往下一個系統設定頁面，找到並進入「已安裝的服務」，開啟「CevizSoft Remote Input」服務。"),
        ...
        ("Turned off", "已關閉"),
        ("Language", "語言"),
        ("Keep CevizSoft Remote background service", "保持 CevizSoft Remote 後台服務"),
        ("Ignore Battery Optimizations", "忽略電池最佳化"),
        ("android_open_battery_optimizations_tip", "如果您想要停用此功能，請前往下一個 CevizSoft Remote 應用程式設定頁面，找到並進入「電池」，取消勾選「不受限制」"),
        ("Start on boot", "開機時啟動"),
        ...
        ("Show CevizSoft Remote", "顯示 CevizSoft Remote"),
        ("This PC", "此電腦"),
        ("or", "或"),
        ("Elevate", "提升權限"),
        ("Zoom cursor", "縮放游標"),
        ...
        ("config_input", "為了能夠透過鍵盤控制遠端桌面，請給予 CevizSoft Remote「輸入監控」權限。"),
        ("config_microphone", "為了支援透過麥克風進行音訊傳輸，請給予 CevizSoft Remote「錄音」權限。"),
        ...
        ("still_click_uac_tip", "依然需要遠端使用者在執行 CevizSoft Remote 時於 UAC 視窗點選「是」。"),
        ...
        ("verify_CevizSoft Remote_password_tip", "驗證 CevizSoft Remote 密碼"),
        ...
        ("{} sessions", "{} 個工作階段"),
        ("scam_title", "您可能遭遇詐騙！"),
        ("scam_text1", "如果您正在和素不相識的人通話，而對方要求您使用 CevizSoft Remote 啟用服務，請勿繼續操作並立即掛斷電話。"),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "請升級專業版伺服器到{}或更高版本！"),
        ...
        ("selinux_tip", "SELinux 處於啟用狀態，CevizSoft Remote 可能無法作為被控端正常運作。"),
        ("Change view", "更改檢視方式"),
        ("Big tiles", "大磁磚"),
        ("Small tiles", "小磁磚"),
        ("List", "清單"),
        ...
        ("powered_by_me", "由 CevizSoft Remote 提供支援"),
        ...
        ("allow-only-conn-window-open-tip", "只在 CevizSoft Remote 視窗開啟時允許連接"),
        ...
        ("floating_window_tip", "有助於保持 CevizSoft Remote 後台服務"),
        ...
        ("About CevizSoft Remote", "關於 CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "請將遠端 CevizSoft Remote 客戶端升級到 {} 或更新版本！"),
        ...
        ("allow-insecure-tls-fallback-tip", "預設情況下，對於使用 TLS 的協定，CevizSoft Remote 會驗證伺服器的憑證。\n啟用此選項後，在驗證失敗時，CevizSoft Remote 將轉為跳過驗證步驟並繼續連接。"),
        ("Disable UDP", "停用 UDP"),
        ("disable-udp-tip", "控制是否僅使用 TCP。\n啟用此選項後，CevizSoft Remote 將不再使用 UDP 21116，而是使用 TCP 21116。"),
        ("server-oss-not-support-tip", "注意：CevizSoft Remote 開源伺服器 (OSS server) 不包含此功能。"),
