...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο CevizSoft Remote..."),
        ...
        ("install_tip", "Λόγω UAC, το CevizSoft Remote ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το CevizSoft Remote στο σύστημα"),
        ("Click to upgrade", "Κάντε κλίκ για αναβάθμιση τώρα"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για να ελέγξετε την επιφάνεια εργασίας σας από απόσταση, πρέπει να παραχωρήσετε στο CevizSoft Remote το δικαίωμα της \"Προσβασιμότητας\"."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στην επιφάνεια εργασίας σας, πρέπει να παραχωρήσετε στο CevizSoft Remote το δικαίωμα της \"Εγγραφή οθόνης\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο CevizSoft Remote να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλούμε να μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος CevizSoft Remote]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep CevizSoft Remote background service", "Διατήρηση της υπηρεσίας παρασκηνίου του CevizSoft Remote"),
        ...
        ("Show CevizSoft Remote", "Εμφάνιση του CevizSoft Remote"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με το πληκτρολόγιο, πρέπει να παραχωρήσετε στο CevizSoft Remote το δικαίωμα της \"Παρακολούθηση εισόδου\"."),
        ("config_microphone", "Για να μιλήσετε εξ αποστάσεως, πρέπει να παραχωρήσετε στο CevizSoft Remote το δικαίωμα της \"Εγγραφή ήχου\"."),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο πλήκτρο Εντάξει στο παράθυρο UAC όπου εκτελείται το CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Επιβεβαιώστε τον κωδικό του CevizSoft Remote"),
        ...
        ("scam_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το CevizSoft Remote, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε το CevizSoft Remote Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Το SELinux είναι ενεργοποιημένο στη συσκευή σας, κάτι που ενδέχεται να εμποδίσει την σωστή λειτουργία του CevizSoft Remote ως ελεγχόμενης πλευράς."),
        ...
        ("powered_by_me", "Με την υποστήριξη του CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Να επιτρέπεται η σύνδεση μόνο εάν το παράθυρο CevizSoft Remote είναι ανοιχτό"),
        ...
        ("floating_window_tip", "Βοηθά στη διατήρηση της υπηρεσίας παρασκηνίου CevizSoft Remote"),
        ("Keep screen on", "Διατήρηση οθόνης Ανοιχτή"),
        ("Never", "Ποτέ"),
        ("During controlled", "Κατα την διάρκεια απομακρυσμένου ελέγχου"),
        ("During service is on", "Κατα την εκκίνηση της υπηρεσίας CevizSoft Remote"),
        ...
        ("About CevizSoft Remote", "Πληροφορίες για το CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Αναβαθμίστε τον πελάτη CevizSoft Remote στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Από προεπιλογή, το CevizSoft Remote επαληθεύει το πιστοποιητικό διακομιστή για πρωτόκολλα που χρησιμοποιούν TLS.\nΜε ενεργοποιημένη αυτήν την επιλογή, το CevizSoft Remote θα παρακάμψει το βήμα επαλήθευσης και θα προχωρήσει σε περίπτωση αποτυχίας επαλήθευσης."),
        ("Disable UDP", "Απενεργοποίηση UDP"),
        ("disable-udp-tip", "Ελέγχει εάν θα χρησιμοποιείται μόνο TCP.\nΌταν είναι ενεργοποιημένη αυτή η επιλογή, το CevizSoft Remote δεν θα χρησιμοποιεί πλέον το UDP 21116, αλλά θα χρησιμοποιείται το TCP 21116."),
        ("server-oss-not-support-tip", "ΣΗΜΕΙΩΣΗ: Το OSS του διακομιστή CevizSoft Remote δεν περιλαμβάνει αυτήν τη λειτουργία."),
