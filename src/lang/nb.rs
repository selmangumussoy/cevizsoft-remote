...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til CevizSoft Remote-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan CevizSoft Remote ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere CevizSoft Remote på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi CevizSoft Remote \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi CevizSoft Remote \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi CevizSoft Remote mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [CevizSoft Remote Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for CevizSoft Remote-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi CevizSoft Remote tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi CevizSoft Remote tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Verifiser CevizSoft Remote-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke CevizSoft Remote og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Vennligst oppgrader CevizSoft Remote Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre CevizSoft Remote i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis CevizSoft Remote-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde CevizSoft Remote-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Vennligst oppgrader CevizSoft Remote-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer CevizSoft Remote serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil CevizSoft Remote falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil CevizSoft Remote ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: CevizSoft Remote server OSS inkluderer ikke denne funksjonen."),
