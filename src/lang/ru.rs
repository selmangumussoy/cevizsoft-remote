...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети CevizSoft Remote..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC CevizSoft Remote может работать неправильно на удалённом узле. Чтобы избежать возможных проблем с UAC, нажмите кнопку ниже для установки CevizSoft Remote в системе."),
        ("Click to upgrade", "Нажмите, чтобы обновить"),
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить CevizSoft Remote права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить CevizSoft Remote права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удалённое устройство могло управлять вашим Android-устройством с помощью мыши или нажатий, необходимо разрешить CevizSoft Remote использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"CevizSoft Remote Input\"."),
        ...
        ("Turned off", "Отключён"),
        ("Language", "Язык"),
        ("Keep CevizSoft Remote background service", "Держать в фоне службу CevizSoft Remote"),
        ...
        ("Show CevizSoft Remote", "Показать CevizSoft Remote"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить CevizSoft Remote разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить CevizSoft Remote разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Подтвердить пароль CevizSoft Remote"),
        ...
        ("scam_text1", "Если вы разговариваете по телефону с кем-то, кого вы НЕ ЗНАЕТЕ и НЕ ДОВЕРЯЕТЕ, и он просит вас использовать CevizSoft Remote и запустить его службу, не продолжайте и немедленно прервите разговор."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Обновите CevizSoft Remote Server Pro до версии {} или новее!"),
        ...
        ("selinux_tip", "На вашем устройстве включён SELinux, что может помешать правильной работе CevizSoft Remote на управляемой стороне."),
        ("Change view", "Вид"),
        ...
        ("powered_by_me", "Основано на CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Разрешать подключение только при открытом окне CevizSoft Remote"),
        ...
        ("floating_window_tip", "Помогает поддерживать фоновую службу CevizSoft Remote"),
        ...
        ("About CevizSoft Remote", "О CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Обновите клиент CevizSoft Remote до версии {} или новее на удалённой стороне!"),
        ...
        ("allow-insecure-tls-fallback-tip", "По умолчанию CevizSoft Remote проверяет сертификат сервера на наличие протоколов, использующих TLS.\nЕсли эта функция включена, CevizSoft Remote пропустит данный этап и продолжит работу в случае неудачной проверки."),
        ("Disable UDP", "Отключить UDP"),
        ("disable-udp-tip", "Определяет, следует ли использовать только TCP.\nЕсли включено, CevizSoft Remote не будет использовать UDP 21116, вместо него будет использоваться TCP 21116."),
        ("server-oss-not-support-tip", "ПРИМЕЧАНИЕ: в OSS-сервере CevizSoft Remote эта функция отсутствует."),
