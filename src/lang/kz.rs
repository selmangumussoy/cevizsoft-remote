...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Дайын"),
        ("Established", "Қосылды"),
        ("connecting_status", "CevizSoft Remote желісіне қосылуда..."),
        ...
        ("install_tip", "UAC кесірінен, CevizSoft Remote кейбірде қашықтағы жақ ретінде дұрыс жұмыс істей алмайды. UAC'пен қиындықты болдырмау үшін, төмендегі батырманы басып CevizSoft Remote'ті жүйеге орнатыңыз."),
        ("Click to upgrade", "Жаңғырту үшін басыңыз"),
        ("Configure", "Қалыптау"),
        ("config_acc", "Сіздің Жұмыс үстеліңізді қашықтан басқару үшін, CevizSoft Remote'ке \"Қолжетімділік\" рұқсаттарын беруіңіз керек."),
        ("config_screen", "Сіздің Жұмыс үстеліңізге қашықтан қол жеткізу үшін, CevizSoft Remote'ке \"Екіренді Жазу\" рұқсаттарын беруіңіз керек."),
        ("Installing ...", "Орнатылу..."),
        ("Install", "Орнату"),
        ...
        ("android_input_permission_tip1", "Қашықтағы құрылғы сіздің Android құрылғыңызды тінтуір немесе түрту арқылы басқару үшін, CevizSoft Remote'ке \"Қолжетімділік\" сербесін қолдануға рұқсат беруініз керек."),
        ("android_input_permission_tip2", "Келесі Жүйе Орнатпалары бетіне барып, [Орнатылған Сербестер]'ді тауып кіріңіз, сосын [CevizSoft Remote Еңгізу] сербесін іске қосыңыз."),
        ...
        ("Language", "Тіл"),
        ("Keep CevizSoft Remote background service", "Артжақтағы CevizSoft Remote сербесін сақтап тұру"),
        ("Ignore Battery Optimizations", "Бәтері Оңтайландыруларын Елемеу"),
        ("android_open_battery_optimizations_tip", "Егер де бұл ерекшелікті өшіруді қаласаңыз, келесі CevizSoft Remote апылқат орнатпалары бетіне барып, [Бәтері]'ні тауып кіріңіз де [Шектеусіз]'ден құсбелгіні алып тастауды өтінеміз"),
        ...
        ("Show CevizSoft Remote", "CevizSoft Remote'ті көрсету"),
        ("This PC", "Бұл ДК"),
        ("or", "немесе"),
        ...
        ("config_input", "Қашықтағы жұмыс үстелін пернетақтамен басқару үшін, CevizSoft Remote'ке \"Еңгізуді Қадағалау\" рұқсаттарын беруіңіз керек."),
        ("config_microphone", "Қашықтан сөйлесу үшін, CevizSoft Remote'ке \"Аудио Жазу\" рұқсаттарын беруіңіз керек."),
        ...
        ("still_click_uac_tip", "Қашықтағы қолданушыдан CevizSoft Remote іске қосылған UAC терезесінде OK басуды әлі де талап етеді."),
        ...
        ("verify_CevizSoft Remote_password_tip", "CevizSoft Remote құпия сөзін тексеру"),
        ...
        ("scam_text1", "Егер сіз танымайтын ЖӘНЕ СЕНБЕЙТІН біреумен телефонмен сөйлесіп жатсаңыз және ол сізден CevizSoft Remote қолданып, сербесті іске қосуды сұраса, жалғастырмаңыз да дереу телефонды қойыңыз."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "CevizSoft Remote Server Pro'ны {} немесе одан жаңа нұсқаға жаңартуды өтінеміз!"),
        ...
        ("selinux_tip", "Сіздің құрылғыңызда SELinux қосылған, бұл CevizSoft Remote'тің басқарылатын жақ ретінде дұрыс жұмыс істеуіне кедергі келтіруі мүмкін."),
        ...
        ("powered_by_me", "CevizSoft Remote негізінде"),
        ...
        ("allow-only-conn-window-open-tip", "Тек CevizSoft Remote терезесі ашық болғанда ғана қосылымға рұқсат ету"),
        ...
        ("floating_window_tip", "Ол CevizSoft Remote артжақ сербесін сақтап тұруға көмектеседі"),
        ...
        ("About CevizSoft Remote", "CevizSoft Remote туралы"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Қашықтағы жақтағы CevizSoft Remote клиентін {} немесе одан жоғары нұсқаға жаңартуды өтінеміз!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Әдепкіде CevizSoft Remote TLS қолданатын протоколдар үшін сербер сертификатын тексереді.\nБұл опция қосылғанда, CevizSoft Remote тексеру сәтсіз болған жағдайда тексеру қадамын өткізіп жіберуге қайтып, жалғастырады."),
        ("Disable UDP", "UDP-ні өшіру"),
        ("disable-udp-tip", "Тек TCP қолданатынын-қолданбайтынын басқарады.\nБұл опция қосылғанда, CevizSoft Remote енді UDP 21116 қолданбайды, оның орнына TCP 21116 қолданылады."),
        ("server-oss-not-support-tip", "ЕСКЕРТПЕ: CevizSoft Remote server OSS бұл ерекшелікті қамтымайды."),
