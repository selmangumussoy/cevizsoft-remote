...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till CevizSoft Remote..."),
        ...
        ("install_tip", "På grund av UAC, kan inte CevizSoft Remote fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera CevizSoft Remote på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge CevizSoft Remote \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge CevizSoft Remote \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [CevizSoft Remote Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep CevizSoft Remote background service", "Behåll CevizSoft Remote i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa CevizSoft Remote programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show CevizSoft Remote", "Visa CevizSoft Remote"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge CevizSoft Remote behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge CevizSoft Remote behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Verifiera CevizSoft Remote-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda CevizSoft Remote och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Uppgradera CevizSoft Remote Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra CevizSoft Remote från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om CevizSoft Remote-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla CevizSoft Remote-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Uppgradera CevizSoft Remote-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar CevizSoft Remote serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar CevizSoft Remote över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder CevizSoft Remote inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: CevizSoft Remote server OSS inkluderar inte denna funktion."),
