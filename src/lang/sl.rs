...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem CevizSoft Remote..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, CevizSoft Remote v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate CevizSoft Remoteu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate CevizSoft Remoteu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno CevizSoft Remoteu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »CevizSoft Remote Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep CevizSoft Remote background service", "Ohrani CevizSoft Remoteovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije CevizSoft Remote, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "CevizSoft Remote potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "CevizSoft Remote potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Preveri geslo za CevizSoft Remote"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite CevizSoft Remote, prekinite klic in program zaprite."),
        ("scam_text2", "CevizSoft Remote omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Prosimo, nadgradite CevizSoft Remote Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno CevizSoft Remotea odprto"),
        ...
        ("floating_window_tip", "Pomaga pri CevizSoft Remote storitvi v ozadju"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Prosimo, nadgradite CevizSoft Remote odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto CevizSoft Remote preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo CevizSoft Remote ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, CevizSoft Remote ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik CevizSoft Remote OSS ne vključuje te funkcije."),
