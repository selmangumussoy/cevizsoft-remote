...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete CevizSoft Remote..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), CevizSoft Remote potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare CevizSoft Remote a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a CevizSoft Remote il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a CevizSoft Remote il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a CevizSoft Remote di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [CevizSoft Remote Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep CevizSoft Remote background service", "Mantieni il servizio di CevizSoft Remote in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione CevizSoft Remote, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show CevizSoft Remote", "Visualizza CevizSoft Remote"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a CevizSoft Remote 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a CevizSoft Remote."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Conferma password CevizSoft Remote"),
        ...
        ("Exit", "Esci da CevizSoft Remote"),
        ("Open", "Apri CevizSoft Remote"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare CevizSoft Remote e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Aggiorna CevizSoft Remote Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di CevizSoft Remote come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra CevizSoft Remote è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio CevizSoft Remote in background."),
        ...
        ("About CevizSoft Remote", "Info su CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Aggiorna il client CevizSoft Remote remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, CevizSoft Remote verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, CevizSoft Remote salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, CevizSoft Remote non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server CevizSoft Remote non include questa funzionalità."),
