...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới CevizSoft Remote..."),
        ...
        ("install_tip", "Do cơ chế UAC, CevizSoft Remote có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt CevizSoft Remote vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho CevizSoft Remote."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho CevizSoft Remote."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [CevizSoft Remote Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep CevizSoft Remote background service", "Giữ dịch vụ CevizSoft Remote chạy nền"),
        ...
        ("Show CevizSoft Remote", "Hiện CevizSoft Remote"),
        ...
        ("verify_CevizSoft Remote_password_tip", "Xác thực mật khẩu CevizSoft Remote"),
        ...
        ("scam_text2", "Chỉ sử dụng CevizSoft Remote với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ CevizSoft Remote mở"),
        ...
        ("floating_window_tip", "Giữ CevizSoft Remote trên cùng"),
        ...
        ("About CevizSoft Remote", "Về CevizSoft Remote"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
