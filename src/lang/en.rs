...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the CevizSoft Remote network..."),
        ...
        ("install_tip", "Due to UAC, CevizSoft Remote can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install CevizSoft Remote to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant CevizSoft Remote \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant CevizSoft Remote \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow CevizSoft Remote to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [CevizSoft Remote Input] service."),
        ...
        ("doc_mac_permission", "https://CevizSoft Remote.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next CevizSoft Remote application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant CevizSoft Remote \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant CevizSoft Remote \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running CevizSoft Remote."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Verify CevizSoft Remote password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use CevizSoft Remote and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Please upgrade CevizSoft Remote Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://CevizSoft Remote.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent CevizSoft Remote from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by CevizSoft Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if CevizSoft Remote window is open"),
        ...
        ("floating_window_tip", "It helps to keep CevizSoft Remote background service"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Please upgrade the CevizSoft Remote client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, CevizSoft Remote verifies the server certificate for protocols using TLS.\nWith this option enabled, CevizSoft Remote will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, CevizSoft Remote will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: CevizSoft Remote server OSS doesn't include this feature."),
