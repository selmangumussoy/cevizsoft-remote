...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zbog UAC CevizSoft Remote ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate CevizSoft Remote na sistem."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfigurisanje"),
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, CevizSoft Remote-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, CevizSoft Remote-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite CevizSoft Remote-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [CevizSoft Remote Input] servis."),
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje CevizSoft Remote aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("Show CevizSoft Remote", "Prikazi CevizSoft Remote"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
        ("Elevate", "Izdigni"),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite CevizSoft Remote-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite CevizSoft Remote-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog CevizSoft Remote-a."),
        ...
        ("verify_CevizSoft Remote_password_tip", "Potvrdi CevizSoft Remote lozinku"),
        ...
        ("scam_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite CevizSoft Remote i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ...
        ("upgrade_CevizSoft Remote_server_pro_to_{}_tip", "Molimo nadogradite CevizSoft Remote Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti CevizSoft Remote da radi pravilno kao kontrolisana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je CevizSoft Remote prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se CevizSoft Remote pozadinski servis održi"),
        ...
        ("About CevizSoft Remote", "O CevizSoft Remote-u"),
        ...
        ("upgrade_remote_CevizSoft Remote_client_to_{}_tip", "Molimo nadogradite CevizSoft Remote klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Podrazumevano, CevizSoft Remote proverava sertifikat servera za protokole koji koriste TLS.\nSa omogućenom ovom opcijom, CevizSoft Remote će preskočiti korak provere i nastaviti u slučaju neuspele provere."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Kontroliše da li se koristi samo TCP.\nKada je ova opcija omogućena, CevizSoft Remote više neće koristiti UDP 21116, umesto toga će se koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: CevizSoft Remote server OSS ne uključuje ovu funkciju."),
